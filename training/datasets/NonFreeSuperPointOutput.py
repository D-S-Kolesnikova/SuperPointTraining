...
from ..utils.tools import match_pair
from ..visualization.viz2d import plot_image_grid
from .base_dataset import BaseDataset

from ...gluefactory_nonfree.superpoint import SuperPoint
from ...gluefactory_nonfree.lightglue import LightGlue
...
class Cascade(BaseDataset, torch.utils.data.Dataset):
    default_conf = {
    ...
    def __getitem__(self, idx):
        ...
        feats0 = extractor.extract(data0, **self.preprocessor)
        feats0, feats1, matches01 = match_pair(extractor, matcher, data0, data1)
